...
public class listarActividades extends JInternalFrame {
	...
	public listarActividades(IControladorActividad ControlAct) {
		...
		lblNewLabel_2.setBounds(29, 267, 112, 14);
		getContentPane().add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Duracion");
		lblNewLabel_3.setBounds(29, 292, 112, 14);
		getContentPane().add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("Costo");
		lblNewLabel_4.setBounds(29, 323, 112, 14);
		getContentPane().add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("Lugar");
		lblNewLabel_5.setBounds(29, 362, 112, 14);
		...
		textFieldDescripcion.setBounds(151, 267, 257, 20);
		getContentPane().add(textFieldDescripcion);
		textFieldDescripcion.setColumns(10);
		
		textFieldDuracion = new JTextField();
		textFieldDuracion.setEditable(false);
		textFieldDuracion.setBounds(151, 292, 257, 20);
		getContentPane().add(textFieldDuracion);
		textFieldDuracion.setColumns(10);
		
		textFieldCosto = new JTextField();
		textFieldCosto.setEditable(false);
		textFieldCosto.setBounds(151, 323, 257, 20);
		getContentPane().add(textFieldCosto);
		textFieldCosto.setColumns(10);
		
		textFieldLugar = new JTextField();
		textFieldLugar.setEditable(false);
		textFieldLugar.setBounds(151, 359, 257, 20);
		getContentPane().add(textFieldLugar);
		textFieldLugar.setColumns(10);
		JLabel lblNewLabel_2_1 = new JLabel("Entrenador Designado");
		lblNewLabel_2_1.setBounds(29, 237, 112, 14);
		...
		textFieldEntrenadorDesignado.setBounds(151, 236, 257, 20);
        ...
        btnLimpiar.setBounds(209, 390, 132, 21);
